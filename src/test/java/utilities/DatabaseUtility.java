...
public class DatabaseUtility {
    ...
    public static List<String> getColumnNames(String query, String columnName){
        ...
        //Bos bur String listi olusturduk

        for(Object herData : data){
            donusenData.add(herData.toString());
            //Obje listini String listine aktardik
        }


        return donusenData;
        //String listesini return ediyoruz

    }
    public static List<String> getColumnDataAsString(List<Object> data){
    ...
    public static List<String> getColumnDataAsString(String query, String columnname){
        List<String> extratedData = new ArrayList<>();
     ...
     * @return list of values of a single column from the result set
     */
    public static List<Object> getColumnDataa(String query, String column) {
        executeQuery(query);
        List<Object> rowList = new ArrayList<>();
        ResultSetMetaData rsmd;
        try {
